...
@testset "Testing equations" begin
    ...
    p = MiCroSim.ParamStruct(10, 10, 1:10, ones(10, 10, 10), ones(Int64, 10, 10), ones(Float64, 10, 10), ones(Int64, 10), ones(Float64, 10), ones(10), 1, 1, ones(10), ones(10), ones(10), ones(10), true)
    t = 0
